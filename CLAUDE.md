...
This project is indexed by GitNexus as **manga-tl-worker** (1939 symbols, 3841 relationships, 165 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
