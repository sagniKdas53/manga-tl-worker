...
This project is indexed by GitNexus as **manga-tl-worker** (1712 symbols, 3376 relationships, 145 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
