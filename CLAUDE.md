...
This project is indexed by GitNexus as **manga-tl-worker** (1391 symbols, 2659 relationships, 113 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
