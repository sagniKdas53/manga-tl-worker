...
This project is indexed by GitNexus as **manga-tl-worker** (1735 symbols, 3422 relationships, 147 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
