...
This project is indexed by GitNexus as **manga-tl-worker** (1301 symbols, 2487 relationships, 98 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
