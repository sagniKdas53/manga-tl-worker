...
This project is indexed by GitNexus as **manga-tl-worker** (1850 symbols, 3623 relationships, 154 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
