...
This project is indexed by GitNexus as **manga-tl-worker** (2047 symbols, 4229 relationships, 174 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
