import pytest
from worker.services.layout import bubble_compare, classify_region_type, group_conversations, chunk_regions_by_conversation
...
def test_group_conversations():
    regions = [
        {"id": "1", "panelReadingOrder": 1, "bubbleReadingOrder": 1, "regionType": "speech", "bboxY": 100, "bboxH": 50},
        {"id": "2", "panelReadingOrder": 1, "bubbleReadingOrder": 2, "regionType": "speech", "bboxY": 120, "bboxH": 50},
        {"id": "3", "panelReadingOrder": 1, "bubbleReadingOrder": 3, "regionType": "sfx", "bboxY": 500, "bboxH": 50},
