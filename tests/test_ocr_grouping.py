...
def test_process_ocr_different_shapes(
    ...
    circle_poly = [[130, 100], [150, 110], [160, 130], [150, 150], [130, 160], [110, 150], [100, 130], [110, 110]]
    ellipse_poly = [[230, 190], [260, 210], [260, 250], [230, 270], [200, 250], [200, 210]]
    pentagon_poly = [[330, 300], [370, 320], [360, 370], [300, 370], [290, 320]]

    mock_detect_bubbles_yolo.return_value = [
        {"bbox": [0, 0, 60, 60], "confidence": 0.9, "mask_polygon": square_poly, "safe_rect": [5, 5, 50, 50]},
        {"bbox": [100, 100, 60, 60], "confidence": 0.9, "mask_polygon": circle_poly, "safe_rect": [105, 105, 50, 50]},
        {"bbox": [200, 190, 60, 80], "confidence": 0.9, "mask_polygon": ellipse_poly, "safe_rect": [205, 195, 50, 70]},
        {"bbox": [290, 300, 80, 70], "confidence": 0.9, "mask_polygon": pentagon_poly, "safe_rect": [295, 305, 70, 60]}
    ]
