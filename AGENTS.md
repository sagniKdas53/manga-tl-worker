...
This project is indexed by GitNexus as **manga-tl-worker** (1727 symbols, 3378 relationships, 146 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
