...
This project is indexed by GitNexus as **manga-tl-worker** (1629 symbols, 3183 relationships, 136 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
