...
This project is indexed by GitNexus as **manga-tl-worker** (975 symbols, 1825 relationships, 79 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
