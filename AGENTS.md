...
This project is indexed by GitNexus as **manga-tl-worker** (2034 symbols, 4200 relationships, 173 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
